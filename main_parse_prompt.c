...
int	main(int ac, char *av[], char **envp)
{
	...
	init_env(&msh);
	init_msh(&msh, envp);
	// char *prompt = "export a=\"s -la\"";
	// char *prompt = "\"s\"\"a\"\"\101lut ca va\" \v bien ou 'k''o''i' |echo \"BON$PATH\" <>\"l\"\'s\'sss \'sa\"lu\"t\' \"l\"\'s\'  $a\"PATH\" \"redir >> dquotes\" \'pipe | squote\'";
	...
	// char *prompt = NULL;
	// char *prompt = "\"ls > rt\"";
	// char *prompt = "echo \"$PAT\" salut ";
	// char *prompt = "echo \"bon>ls\" ";
	// char *prompt = "salut \"";
	// char *prompt = "echo $asda\"PATH\"";
	char *prompt = "echo \"bonjo\"ur\"";
